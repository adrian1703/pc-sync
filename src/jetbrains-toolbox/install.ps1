...
$dl_link="https://download.jetbrains.com/toolbox/jetbrains-toolbox-2.5.2.35332.exe"
$installer="toolbox_install.exe"
$dl_folder="$env:TMP"
$installer_full_path=Join-Path $dl_folder $installer
$trgt_folder=Join-Path $env:IDES "jetbrains\toolbox" # this is somehow sometimes lowercase dont ask me why
